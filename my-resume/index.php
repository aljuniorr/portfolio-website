        ...
        <div class="col-lg-4 col-md-6 isotope-item filter-product">
          <div class="d-flex flex-column bg-white border border-light rounded-4 shadow-sm h-100">
            ...
            <div class="overflow-hidden rounded-top">
              <img src="assets/img/portfolio/telco.jpg" alt="" class="w-100" style="height: 200px; object-fit: cover;">
            </div>

            <!-- Content -->
            <div class="p-3 d-flex flex-column flex-grow-1">
              <h4>Telco Customer Churn</h4>
              ...
              <p class="m-0 p-0 mb-3">
                This project demonstrates how I used Python and SQL to analyze and visualize sales data.
                The dashboard includes key insights and automated reporting features.
              </p>

          <a href="portfolio-details.php?id=telco-customer-churn" 
    ...
    <path fill-rule="evenodd"
        ...
        <div class="col-lg-4 col-md-6 isotope-item filter-product">
          <div class="d-flex flex-column bg-white border border-light rounded-4 shadow-sm h-100">
            ...
            <!-- Image -->
            <div class="overflow-hidden rounded-top">
              <img src="assets/img/portfolio/tj.jpg" alt="" class="w-100" style="height: 200px; object-fit: cover;">
            </div>

            <!-- Content -->
            <div class="p-3 d-flex flex-column flex-grow-1">
              <h4>Transjakarta Data Analysis</h4>
              ...
              <p class="m-0 p-0 mb-3">
                Transjakarta, as the major public transportation service provider in Jakarta, aims to optimize its services to meet the needs of its customers effectively. This project involves analyzing customer transaction data to uncover patterns and insights that can drive operational improvements.
              </p>

         <a href="portfolio-details.php?id=transjakarta-analysis" 
   class="btn btn-link text-primary d-inline-flex align-items-center gap-4 p-0 text-decoration-none mt-auto">
  Read More
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
       class="bi bi-arrow-right text-primary" viewBox="0 0 16 16">
    <path fill-rule="evenodd"
        ...
        <div class="col-lg-4 col-md-6 isotope-item filter-product">
          <div class="d-flex flex-column bg-white border border-light rounded-4 shadow-sm h-100">
            ...
            <!-- Image -->
            <div class="overflow-hidden rounded-top">
              <img src="assets/img/portfolio/fifa.jpg" alt="" class="w-100" style="height: 200px; object-fit: cover;">
            </div>

            <!-- Content -->
            <div class="p-3 d-flex flex-column flex-grow-1">
              <h4>FIFA World Cup 2014 Stats</h4>
              ...
              <p class="m-0 p-0 mb-3">
                The FIFA World Cup 2014 in Brazil, was a landmark event in the world of football. This project aims to capture the excitement and key moments of the tournament through a detailed and interactive Tableau dashboard. Providing a valuable resource for football enthusiasts, analysts, and researchers.
 <a href="portfolio-details.php?id=fifa-world-cup-2014" 
   class="btn btn-link text-primary d-inline-flex align-items-center gap-4 p-0 text-decoration-none mt-auto">
  Read More
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
       class="bi bi-arrow-right text-primary" viewBox="0 0 16 16">
